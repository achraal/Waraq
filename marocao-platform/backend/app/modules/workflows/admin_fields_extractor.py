...
class AdminFieldsExtractor:
    ...
    def _is_valid_field_label(self, label: str) -> bool:
        ...
        keywords = [
            "nom", "prénom", "qualité", "adresse", "domicile", "siège",
            "raison sociale", "forme juridique", "capital", "numéro",
            "registre", "commerce", "taxe", "identifiant", "ice",
            "affilié", "affiliée", "mandataire", "membre",
            "montant", "taux", "compte", "banque", "postal",
            "rib", "localité", "titulaire", "fait à", "le",
        ]
